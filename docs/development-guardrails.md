...
#
# Placeholders:
#   {files} - the OpenAPI specs declared in micro-contracts.config.yaml
#             (a check whose {files} cannot be expanded fails: a command run
#              without files would report success having inspected nothing)
